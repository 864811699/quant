...
class ZmqSubscriber:
    ...
    def __init__(self, address=["tcp://127.0.0.1:5555"], topic_filter="market",setsockopt=True, timeout=500):
        """
        :param address: 发布者地址
        ...
        self.socket.connect(self.addres)
