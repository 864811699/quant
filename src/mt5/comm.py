...
ORDER_STATUS_NOT_CONNECTED = 7

STATUS_TO_ZMQ={
    mt5.ORDER_STATE_STARTED:ORDER_STATUS_UNKNOWN,
    mt5.ORDER_STATE_PLACED:ORDER_STATUS_UNKNOWN,
    mt5.ORDER_STATE_CANCELED:ORDER_STATUS_CANCELED,
    mt5.ORDER_STATE_PARTIAL:ORDER_STATUS_PARTTRADE,
    mt5.ORDER_STATE_FILLED:ORDER_STATUS_AllTrade,
    mt5.ORDER_STATE_REJECTED:ORDER_STATUS_REJECTED,
    mt5.ORDER_STATE_EXPIRED:ORDER_STATUS_REJECTED,
    mt5.ORDER_STATE_REQUEST_ADD:ORDER_STATUS_UNKNOWN,
    mt5.ORDER_STATE_REQUEST_MODIFY:ORDER_STATUS_UNKNOWN,
    mt5.ORDER_STATE_REQUEST_CANCEL:ORDER_STATUS_REJECTED,
}
REQ_POSITION = "P"
REQ_ORDER = "O"
REQ_MARKET = "M"
